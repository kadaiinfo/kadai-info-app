...
/// @nodoc
class _$TimetableEditColorFormStateTearOff {
  const _$TimetableEditColorFormStateTearOff();

  _TimetableEditColorFormState call({required Color selectedColor}) {
    return _TimetableEditColorFormState(
...
/// @nodoc
const $TimetableEditColorFormState = _$TimetableEditColorFormStateTearOff();
...
class _$_TimetableEditColorFormState implements _TimetableEditColorFormState {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, selectedColor);
...
abstract class _TimetableEditColorFormState
  ...
  const factory _TimetableEditColorFormState({required Color selectedColor}) =
      _$_TimetableEditColorFormState;
