...
/// @nodoc
class _$TimetableLessonModelTearOff {
  const _$TimetableLessonModelTearOff();

  _TimetableLessonModel call(
      {required String id,
...
/// @nodoc
const $TimetableLessonModel = _$TimetableLessonModelTearOff();
...
abstract class _TimetableLessonModel implements TimetableLessonModel {
  const factory _TimetableLessonModel(
      ...
      required int day,
      dynamic room,
      dynamic teacher}) = _$_TimetableLessonModel;
